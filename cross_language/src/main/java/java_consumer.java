...
public class java_consumer {
    ...
    private static void analyzeWithArrow(VectorSchemaRoot root) {
        ...
        for (int i = 0; i < rowCount; i++) {
            totalValue += ((org.apache.arrow.vector.Float8Vector) tradeValueVector).get(i);
        }
        ...
        double sumPrice = 0.0;
        for (int i = 0; i < rowCount; i++) {
            sumPrice += ((org.apache.arrow.vector.Float8Vector) priceVector).get(i);
        }
        ...
        for (int i = 0; i < rowCount; i++) {
            if (((org.apache.arrow.vector.Float8Vector) tradeValueVector).get(i) > 100000.0) {
                highValueCount++;
            }
        }
        ...
        org.apache.arrow.vector.Float8Vector priceVec = (org.apache.arrow.vector.Float8Vector) priceVector;
        double minPrice = Double.MAX_VALUE;
        double maxPrice = Double.MIN_VALUE;
        double sum = 0.0;
        for (int i = 0; i < rowCount; i++) {
            double price = priceVec.get(i);
        ...
        for (int i = 0; i < rowCount; i++) {
            double diff = priceVec.get(i) - mean;
        ...
        org.apache.arrow.vector.Float8Vector tradeValueVec = (org.apache.arrow.vector.Float8Vector) tradeValueVector;
        org.apache.arrow.vector.VarCharVector symbolVec = (org.apache.arrow.vector.VarCharVector) symbolVector;
        Map<String, Double> volumeBySymbol = new HashMap<>();
        for (int i = 0; i < rowCount; i++) {
            String symbol = new String(symbolVec.get(i));
            double value = tradeValueVec.get(i);
